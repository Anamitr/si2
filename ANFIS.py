...
class ANFIS:
    ...
    def show_results(self, color=None, save_name: str = None):
    ...
    def show_results_in_4d_for_given_x(self, x:list):
        fig = plt.figure()
        ax = fig.add_subplot(111, projection='3d')
    ...
    def train_with_x(self, x0: list, learn_premises: bool, learn_operators: bool, learn_consequents: bool,
                     n_iter=100, bounds_premises=None):
